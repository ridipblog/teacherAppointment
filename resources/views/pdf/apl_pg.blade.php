...
<body>
    ...
    <p><strong>No. DE/BTC/Aptt-3/PGT/2025/<span class="underline">{{$candDetails->letterCode ?? ''}}</span></strong> In exercise of power conferred upon the Director of Education,
        ...
        any time without notice and without assigning any reason thereof Sri/Ms <span class="underline">{{$candDetails->name ?? ''}}</span>, S/o,/D/o,/W/o, Sri
        ...
        Retired/Expired/VRS/Transferred/Resigned.</p>
    ...
    <div class="footer">
        ...
        <ol>
            ...
            <li>The Principal, {{$candDetails->vacency_details->school_vacency->schoolName ?? ''}}  for information.</li>
