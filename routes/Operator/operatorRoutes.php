...
// Route::get('/slide-cuurent-vacency-districts',[OperatorController::class,'cuurentVacencyDistricts'])->name('operator.cuurentVacencyDistricts');
// *** Current Vacency Page ***
// Route::get('/slide-cuurent-vacency/{districts?}',[OperatorController::class, 'CurrentVacency'])->name('operator.CurrentVacency');
